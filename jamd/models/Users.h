...
namespace drogon_model::jamd
{
    ...
    public:
        struct Cols
        {
            ...
            static const std::string _primary_email;
        ...
        using PrimaryKeyType = std::tuple<std::string,std::string>;//name,nickname
     ...
     */
        ...
        /**  For column primary_email  */
        ///Get the value of the column primary_email, returns the default value if the column is null
        const std::string &getValueOfPrimaryEmail() const noexcept;
        ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
        const std::shared_ptr<std::string> &getPrimaryEmail() const noexcept;
        ///Set the value of the column primary_email
        void setPrimaryEmail(const std::string &pPrimaryEmail) noexcept;
        void setPrimaryEmail(std::string &&pPrimaryEmail) noexcept;
        void setPrimaryEmailToNull() noexcept;

        /**  For column extra_emails  */
        ///Get the value of the column extra_emails, returns the default value if the column is null
        const std::string &getValueOfExtraEmails() const noexcept;
        ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
        const std::shared_ptr<std::string> &getExtraEmails() const noexcept;
        ///Set the value of the column extra_emails
        void setExtraEmails(const std::string &pExtraEmails) noexcept;
    ...
    private:
        ...
        std::shared_ptr<std::string> primaryEmail_;
    ...
    public:
        ...
        {
            static const std::string sql="select * from " + tableName + " where name = $1 and nickname = $2";
            return sql;
        }

        static const std::string &sqlForDeletingByPrimaryKey()
        {
            static const std::string sql="delete from " + tableName + " where name = $1 and nickname = $2";
            return sql;
        }
